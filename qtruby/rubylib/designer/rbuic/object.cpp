...
QString Uic::createObjectImpl( const QDomElement &e, const QString& parentClass, const QString& par, const QString& layout )
{
	...
	if ( n.tagName() == "property" ) {
		...
		if ( stdset )
		    ...
		    out << indent << fullObjName << ".setProperty(\"" << prop << "\", Qt::Variant.new(" << value << "))" << endl;
	    }
