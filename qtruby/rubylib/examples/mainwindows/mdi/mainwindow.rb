...
class MainWindow < Qt::MainWindow
	...
	def updateMenus()
	    ...
	    @arrangeAct.enabled = hasMdiChild
	...
	def createActions()
	    ...
	    @arrangeAct = Qt::Action.new(tr("Arrange &icons"), self)
	    @arrangeAct.statusTip = tr("Arrange the icons")
	...
	def findMdiChild(fileName)
		...
		@workspace.windowList().each do |window|
	        mdiChild = window
