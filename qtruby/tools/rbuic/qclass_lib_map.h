...
QT_CLASS_LIB(QAbstractXmlReceiverPointer, QtXmlPatterns, qabstractxmlreceiver.h)
...
QT_CLASS_LIB(QXmlFormatterPointer, QtXmlPatterns, qxmlformatter.h)
...
QT_CLASS_LIB(QXmlSerializerPointer, QtXmlPatterns, qxmlserializer.h)
