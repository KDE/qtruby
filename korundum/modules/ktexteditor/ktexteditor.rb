=begin
/***************************************************************************
                          ktexteditor.rb  -  KTextEditor ruby lib
                             -------------------
...
#          now = classname.sub(/^KTextEditor?(?=[A-Z])/,'KTextEditor::')
#        end
#        now
#      end)
      getClassList.each do |c|
        ...
        klass = Qt::Internal::isQObject(c) ? Qt::Internal::create_qobject_class(classname, KTextEditor) \
                                           : Qt::Internal::create_qt_class(classname, KTextEditor)
